...
sub_train <- read.table("/Users/chaitu/Downloads/UCI HAR Dataset/train/subject_train.txt")

# read test data 
x_test   <- read.table("/Users/chaitu/Downloads/UCI HAR Dataset/test/X_test.txt")
y_test   <- read.table("/Users/chaitu/Downloads/UCI HAR Dataset/test/Y_test.txt") 
sub_test <- read.table("/Users/chaitu/Downloads/UCI HAR Dataset/test/subject_test.txt")

# read features description 
features <- read.table("/Users/chaitu/Downloads/UCI HAR Dataset/features.txt") 

# read activity labels 
activity_labels <- read.table("/Users/chaitu/Downloads/UCI HAR Dataset/activity_labels.txt") 
